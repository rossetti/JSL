...
import jsl.controls.AnnotationControls;
...
public class Test extends TestAbstract {
    ...
    @Override
    @BooleanControl(comment = "Control required by the interface 'TestIfc' but " +
    ...
    public static void main(String args[]){
        ...
        AnnotationControls cs = AnnotationControls.extractControls(mod);
