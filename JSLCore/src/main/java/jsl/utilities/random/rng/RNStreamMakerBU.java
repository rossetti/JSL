...
public class RNStreamMakerBU extends Identity {
    ...
    private static RNStreamMakerBU DefaultFactory = new RNStreamMakerBU("Default");
     ...
     */
    public RNStreamMakerBU(String name) {
        super(name);
    }
     ...
     */
    public RNStreamMakerBU newInstance(String name) {
        RNStreamMakerBU f = new RNStreamMakerBU(name);
...
//            sb.append("\n");
    ...
    public static void main(String[] args) {
        RNStreamMakerBU rm = new RNStreamMakerBU();
