 ...
 */
public class ResourceUnitExample1 extends SchedulingElement {
    ...
    public ResourceUnitExample1(ModelElement parent) {
        this(parent, new ExponentialRV(1.0), new ExponentialRV(0.5));
    }

    public ResourceUnitExample1(ModelElement parent, RandomIfc ad, RandomIfc sd) {
        super(parent);
        setServiceRS(sd);
        setArrivalRS(ad);
...
//                .collectStateStatistics()
    ...
    public static void main(String[] args) {
        ...
        ResourceUnitExample1 example1 = new ResourceUnitExample1(m);
